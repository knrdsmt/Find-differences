...
# Determine bounding box for the largest object
...
cropped = image2[y_min:y_max, x_min:x_max]
image3 = np.copy(cropped)
cropped1 = image1[y_min:y_max, x_min:x_max]
cropped2 = image2[y_min:y_max, x_min:x_max]

difference_cropped = np.abs(cropped1.astype(int) - cropped2.astype(int)).astype(np.uint8)
