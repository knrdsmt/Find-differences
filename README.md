...
1. **Reading Bounding Box Information**: The program reads the bounding box information generated by `image_difference.py`. This information defines the region of interest (ROI) where differences were detected.
